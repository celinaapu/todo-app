...
export const VitalTaskPage: FC = () => {
  return (
    <div className="w-[100%] h-[100%]  bg-gray-200 flex flex-row gap-5 pt-4">
      <div>
        <SidebarDashboard />
      </div>
      <div className="w-[30%] mt-5 h-[100%] border-gray-400 rounded-lg py-2 px-3 border">
      ...
      <div className="w-[35%] mt-5 py-4 px-4  h-[100%] border-gray-400 border rounded-lg">
        ...
        <div className="mt-20 flex flex-row gap-3 text-end justify-end items-end">
          <div
            role="button"
            className="bg-red-600 rounded-sm items-center text-center justify-center h-4 w-6 pl-1 text-white "
          >
            <MdDelete />
          </div>
          <div
            role="button"
            className="bg-red-600 items-center rounded-sm text-center justify-center h-4 w-6 pl-1 text-white "
          >
            <RiEditBoxFill />
          </div>
        </div>
